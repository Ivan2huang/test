...
export const enrichProfileWithBenefits = (
  ...
  const {
    ...
    externalBenefits: consumerBenefits,
  } = benefits;
  if (memberProfile && staffBenefits) {
    const {
      fullName,
      dependants,
      preferredLocale,
    ...
    const { member, relationships } = staffBenefits;
    ...
    result = {
      ...
      coPayments: getMembersCoPayments(staffBenefits, policy),
      healthCards,
    ...
    result = {
      ...
      policy: {
        expiryDate,
        initialDate,
        insurer: { myBenefitsName: insurerName },
        policyNumber,
      },
      consumerBenefits: benefitGroups,
      profilePolicyNumber: memberProfile.policyNumber,
      profileCertificateNumber: memberProfile.certificateNumber,
      healthCards,
    };
