...
describe('Helper', () => {
  it('should return user profile with benefits for member with no dependents', () => {
    ...
    const actual = enrichProfileWithBenefits(
      userProfile,
      { benefits: { ...employeeBenefitResponse, relationships: [] } },
      healthCards,
  ...
  it('should return employee user profile with benefits for member and relationships', () => {
    ...
    const actual = enrichProfileWithBenefits(
      userProfile,
      { benefits: { ...employeeBenefitResponse } },
      healthCards,
      policyDetailsResponse,
    );
  ...
  it('should return the userProfile and employee profile as is when benefits is undefined', () => {
    ...
    const expected = {
      ...
      dependants: [],
      policy: {
        policyNumber: 'cxadevclient1Ref2',
        insurer: {
          myBenefitsName: 'HSBC Life Benefits Plus',
        },
        expiryDate: '2020-12-31T00:00:00',
    ...
    const actual = enrichProfileWithBenefits(
      ...
      {
        externalBenefits: {
          insurerName: 'HSBC Life Benefits Plus',
          policyNumber: 'cxadevclient1Ref2',
          expiryDate: '2020-12-31T00:00:00',
          initialDate: '2020-01-01T00:00:00',
        },
