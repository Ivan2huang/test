...
describe('Me reducer', () => {
    ...
    const action = {
      ...
      payload: {
        memberProfile: {
          ...
          memberPackage: {
            policyNumber: '123',
            initialDate: '1990-01-01T00:00:00',
            expiryDate: '1990-01-01T00:00:00',
            insurer: {
              code: 256,
              name: 'dummy',
            },
  ...
  it('should update the membership in user profile', () => {
    const initialState = {
      profile: {
        fullName: '',
        membershipNumber: '',
    ...
    const action = {
      ...
      payload: {
        membership: {
          ...
          certificateNumber: '0000130',
          planId: 1,
          coPayments: { 1: { GP: 50, SP: 20, PHY: 20 } },
          relationships: [
            {
              memberId: '111',
              membershipNumber: '0000131',
              certificateNumber: '0000131',
              planId: 1,
            },
            {
              memberId: '112',
              membershipNumber: '0000132',
              certificateNumber: '0000132',
              planId: 1,
            },
            {
              memberId: '113',
              membershipNumber: '0000133',
              certificateNumber: '0000133',
              planId: 1,
            },
            {
              memberId: '114',
              membershipNumber: '0000134',
              certificateNumber: '0000134',
              planId: 1,
            },
          ],
        },
  ...
  it('should update the policy in user profile', () => {
    const initialState = {
      profile: {
        fullName: '',
        membershipNumber: '',
          ...
          plans: {
            2: {
              ...
              products: [
                ...
                {
                  name: 'Wellness flexible spending amount',
                  panelLabel: null,
                  nonPanelLabel: null,
  ...
  it('should update mobile number status', () => {
    const initialState = {
      mobileNumberStatus: {
        newValue: '',
        allowedToVerify: false,
