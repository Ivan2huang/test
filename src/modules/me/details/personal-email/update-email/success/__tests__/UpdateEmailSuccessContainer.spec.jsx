...
import UpdateEmailSuccessContainer, {
  mapDispatchToProps,
  mapStateToProps,
} from '../UpdateEmailSuccessContainer';
...
describe('UpdateEmailSuccess Container', () => {
  let store;
  ...
  it('should match snapshot', () => {
    ...
    const Component = withIntl(UpdateEmailSuccessContainer);
